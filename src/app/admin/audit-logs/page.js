                    ...
                    <td colSpan="5" className="p-24 text-center">
                      <div className="flex flex-col items-center justify-center gap-6">
                        <div className="relative w-16 h-16 flex items-center justify-center">
                          ...
                          <div className="absolute inset-2 border-2 border-emerald-500/20 rounded-full"></div>
                          <div className="absolute inset-2 border-2 border-emerald-500 rounded-full border-b-transparent animate-[spin_1.5s_linear_infinite_reverse]"></div>
                          <Cpu className="w-4 h-4 text-indigo-400 absolute" />
                        </div>
                        <div className="space-y-2">
                          <p className="text-gray-300 font-mono text-sm uppercase tracking-widest animate-pulse">Decrypting Telemetry Nodes</p>
                          <p className="text-gray-600 font-mono text-[10px]">&gt;_ ESTABLISHING SECURE CONNECTION...</p>
                        </div>
                      </div>
                    </td>
                  </tr>
                    ...
                    return (
                      <Fragment key={log._id}>
                        ...
                        <tr
                          ...
                          className={`hover:bg-white/[0.02] transition-colors duration-300 cursor-pointer group ${isExpanded ? 'bg-indigo-500/[0.03]' : ''}`}
                        >
            ...
            <div className="p-6 border-t border-white/5 bg-gray-900/60 backdrop-blur-md flex flex-col sm:flex-row justify-between items-center gap-6">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-5 py-2 rounded bg-gray-800 border border-white/5 text-[10px] font-bold font-mono uppercase tracking-[0.2em] text-gray-400 hover:text-white hover:bg-gray-700 hover:border-white/20 disabled:opacity-30 disabled:hover:bg-gray-800 disabled:hover:border-white/5 transition-all w-28 text-center"
                >
                  &lt; Prev
                </button>
                <button
                  ...
                  onClick={() => setPage(p => p + 1)}
                  className="px-5 py-2 rounded bg-gray-800 border border-white/5 text-[10px] font-bold font-mono uppercase tracking-[0.2em] text-gray-400 hover:text-white hover:bg-gray-700 hover:border-indigo-500/30 disabled:opacity-30 disabled:hover:bg-gray-800 disabled:hover:border-white/5 transition-all w-28 text-center"
                >
                  Next &gt;
                </button>
              </div>
