...
export default function CountriesClientWrapper({ initialCountries }) {
    ...
    const columns = [
        ...
        },
        {
            ...
            accessor: 'dial_code',
            render: (c) => (
                <span className={`inline-flex items-center px-2.5 py-1 rounded-sm text-[10px] font-mono tracking-widest uppercase transition-all shadow-[0_0_10px_rgba(0,0,0,0.5)] ${c.isActive !== false ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'bg-rose-500/10 text-rose-400 border border-rose-500/20'}`}>
        ...
        <div className="p-8 max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-2 gap-4">
                <div>
                    ...
                    <p className="text-xs font-mono text-slate-500 tracking-widest uppercase mt-1">Geo-Spatial Territories Matrix ({countries.length} Nodes)</p>
                </div>
            ...
            <CyberTable
                ...
                searchKeys={['name', 'code', 'dial_code', 'currency']}
