...
export default function SupportClientWrapper({ initialInquiries, initialDisputes }) {
  const router = useRouter();
  const [activeTab, setActiveTab] = useState('disputes'); // 'inquiries' or 'disputes'
  const [data, setData] = useState({ inquiries: initialInquiries, disputes: initialDisputes });
