            ...
            <div className="pt-32 pb-20">
                <div className="max-w-4xl mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-500">Last Updated: {policy?.updatedAt ? new Date(policy.updatedAt).toLocaleDateString() : new Date().toLocaleDateString()}</p>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl shadow-gray-200/50 relative overflow-hidden">
                        ...
                        <div className="relative z-10 prose prose-lg prose-indigo max-w-none text-gray-600">
                            ...
                            <div className="border-l-4 border-indigo-500 bg-indigo-50 p-6 rounded-r-xl mt-8 not-prose">
                                ...
                                <p className="text-indigo-800 text-sm">{policy?.content ? 'These terms are managed by administration and subject to change.' : 'These terms are subject to change. We will notify you of any significant changes by updating the date at the top of this policy.'}</p>
                            </div>
                        </div>
                    </div>
                </div>
