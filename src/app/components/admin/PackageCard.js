...
export default function PackageCard({ pkg, onToggleStatus, inspectHref }) {
      ...
      <div className="p-6 pt-2 flex-1 flex flex-col relative z-10">
        <div className="mb-4">
          <div className="flex items-center gap-2 mb-1.5">
            <span className="px-1.5 py-0.5 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 rounded text-[9px] font-mono font-bold uppercase tracking-xs truncate">{pkg.serviceType?.replace(/-/g, ' ')}</span>
