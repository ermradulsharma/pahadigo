...
export default function CyberTable({
    ...
    return (
        <div className="w-full space-y-4">
            ...
            {/* Table Container */}
            <div className="bg-[#0a0a0c]/80 backdrop-blur-xl rounded-xl shadow-[0_10px_30px_rgba(0,0,0,0.8)] border border-white/5 overflow-hidden relative min-h-[200px]">
                ...
                {totalPages > 1 && (
                    <div className="p-4 border-t border-white/5 bg-black/40 flex flex-col sm:flex-row gap-4 items-center justify-between">
                        <div className="text-[10px] sm:text-xs font-mono text-slate-500 tracking-widest uppercase flex items-center gap-3">
                            ...
                            <span>{filteredData.length} Total Nodes</span>
                        </div>
                        <div className="flex items-center gap-1 sm:gap-2">
                            <button onClick={() => setCurrentPage(prev => Math.max(1, prev - 1))} disabled={currentPage === 1} className="px-2 sm:px-3 py-1.5 bg-[#0a0a0c] hover:bg-white/5 disabled:opacity-30 border border-white/10 rounded-md text-slate-300 font-mono text-[10px] sm:text-xs uppercase transition-all shadow-[0_0_10px_rgba(0,0,0,0.5)]">
                                Prev
                            </button>
                                ...
                                {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-7 h-7 sm:w-8 sm:h-8 rounded-md font-mono text-[10px] sm:text-xs flex items-center justify-center transition-all ${page === currentPage ? 'bg-indigo-500/20 text-indigo-400 border border-indigo-500/30 shadow-[0_0_15px_rgba(99,102,241,0.2)]' : 'hover:bg-white/10 text-slate-400 border border-transparent bg-[#0a0a0c]'}`}
                                        >
                                            {page}
                                        </button>
                                    )
                            ...
                            <button
                                ...
                                className="px-2 sm:px-3 py-1.5 bg-[#0a0a0c] hover:bg-white/5 disabled:opacity-30 border border-white/10 rounded-md text-slate-300 font-mono text-[10px] sm:text-xs uppercase transition-all shadow-[0_0_10px_rgba(0,0,0,0.5)]"
                            >
                                Next
                            </button>
                        </div>
