...
export const SYSTEM_ENV = {
    ...
    TAX_HOMESTAY: process.env.TAX_HOMESTAY,
    TAX_HOTEL: process.env.TAX_HOTEL,
    TAX_CAMPING: process.env.TAX_CAMPING,
    TAX_TREKKING: process.env.TAX_TREKKING,
    TAX_RAFTING: process.env.TAX_RAFTING,
    TAX_BUNGEE_JUMPING: process.env.TAX_BUNGEE_JUMPING,
    TAX_BIKE_SCOOTER_RENTAL: process.env.TAX_BIKE_SCOOTER_RENTAL,
    TAX_CHARDHAM_TOUR: process.env.TAX_CHARDHAM_TOUR,
    TAX_CUSTOM_TRIP: process.env.TAX_CUSTOM_TRIP,
