  ...
  ...Router.group({ prefix: '/vendor', middleware: ['auth'], roles: [USER_ROLES.VENDOR] }, [
    ...
    ...Router.group({ prefix: '/business' }, [
      ...
      ...Router.group({ prefix: '/profile' }, [
        ...
        { method: 'PATCH', path: '/status', handler: wrap(VendorController.updateBusinessStatus.bind(VendorController)) },
      ]),
      ...
      // Vendor Business Closure Periods
      ...Router.group({ prefix: '/closures' }, [
        { method: 'GET', path: '/', handler: wrap(VendorController.getClosurePeriods.bind(VendorController)) },
        { method: 'POST', path: '/', handler: wrap(VendorController.addClosurePeriod.bind(VendorController)) },
        { method: 'PATCH', path: '/:id', handler: wrap(VendorController.updateClosurePeriod.bind(VendorController)) },
        { method: 'DELETE', path: '/:id', handler: wrap(VendorController.deleteClosurePeriod.bind(VendorController)) },
      ]),
    ]),
