...
export const seedSettings = async () => {
    try {
        ...
        const settings = {
            ...
            tax_homestay: config.tax.tax_homestay,
            tax_hotel: config.tax.tax_hotel,
            tax_camping: config.tax.tax_camping,
            tax_trekking: config.tax.tax_trekking,
            tax_rafting: config.tax.tax_rafting,
            tax_bungee_jumping: config.tax.tax_bungee_jumping,
            tax_bike_scooter_rental: config.tax.tax_bike_scooter_rental,
            tax_chardham_tour: config.tax.tax_chardham_tour,
            tax_custom_trip: config.tax.tax_custom_trip,
