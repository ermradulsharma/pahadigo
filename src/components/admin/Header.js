    ...
    return (
        <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-6 sticky top-0 z-30 shadow-sm">
            <div className="flex items-center gap-4">
                ...
                <h1 className="text-xl font-bold text-gray-800 tracking-tight">{title || 'Dashboard'}</h1>
            </div>
            <div className="relative" ref={dropdownRef}>
                ...
                {isDropdownOpen && (
                    <div className="absolute right-0 w-56 bg-white rounded-lg shadow-xl z-50 transform origin-top-right transition-all">
                        ...
                        <a href="/admin/profile" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50 hover:text-indigo-700 transition-colors">
